                            ...
                            <template #content="{ close }">
                                <ul class="!py-0 text-dark dark:text-white-dark w-[300px] sm:w-[350px] divide-y dark:divide-white/10">
                                    <li>
                                        <div class="flex items-center px-4 py-2 justify-between font-semibold">
                                            ...
                                            <template v-if="notifications.length">
                                                <span class="badge bg-primary/80" v-text="notifications.length + 'Novas'"></span>
                                            </template>
                                        </div>
                                    </li>
                                    ...
                                    <template v-if="notifications.length">
                                        <li>
                                            <div class="p-4">
                                                <button class="btn btn-primary block w-full btn-small" @click="close()">Ler todas as notificações</button>
                                            </div>
                                        </li>
                                    </template>
                                    <template v-if="!notifications.length">
                            ...
                            <template #content="{ close }">
                                <ul class="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    ...
                                    <li class="border-t border-white-light dark:border-white-light/10">
                                        <router-link to="/login" class="text-danger !py-3" @click="authService.logout();">
